...
import com.xuenen.njxe.utils.ACache;
import com.xuenen.njxe.utils.CrashHandler;
import com.xuenen.njxe.utils.NetUtils;
...
public class BaseApplication extends Application {
    ...
    private User user = null;//保持登录成功的用户信息对象
...
//            cacheDir = appContext.getExternalCacheDir().getAbsolutePath();
//        } else {
//            cacheDir = appContext.getCacheDir().getAbsolutePath();
//        }
//        return cacheDir;
//    }
...
//                        .build();
            ...
            boolean netWorkConection = NetUtils.hasNetWorkConection(BaseApplication.getIntstance());
            Request request = chain.request();
            if (!netWorkConection) {
